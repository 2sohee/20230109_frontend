...
// ++ : 피연산자의 값을 1 증가시킨다. 피연산자의 값을 변화시킨다.
// -- : 피연산자의 값은 1 감소한다. 피연산자의 값을 변화시킨다.
...
//전위 연산자 :  단항 연산자가 앞에 붙으면 우선순위가 가장 먼저 된다.
console.log(num++);
console.log(num);
console.log(10 + num++ + 2);
console.log(num);
console.log(11 + num++ + 2);
...
num03 += 30; //num03(120)에 더한 값을 num03에 다시 할당.
num03 /= 2;
...
/*
논리 연산자 : 두 논리값을 가지고 새로운 값을 만든다.
||(or) : 두 값 중 하나라도 true라면 true 반환 => 둘 다 false 일 때만 false 반환
&&(and) : 두 값 모두 true일때만 true => 둘 중  하나라도 false 라면 false 반환
! : 논리값을 반전 시킨다. => true -> false, false => true
*/

console.log(num04 > 10 || num05 >= 10); // true or false 이기 때문에 flase 반환
console.log(num04 < 10 && num05 > 4); // true and true 이기 대문에 true
