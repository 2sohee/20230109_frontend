...
//num01, num02를 선언하고 각각, 10과 20을 할당하고 두 값을 서로 바꾸기
var num01 = 10;
var num02 = 20;
var temp = num01;
...
//var 1num = 10; 변수명을 숫자로 시작할 수 없다.

//var userList = []; 카멜 케이스, 띄어쓰기 부분을 대문자로 구분한다.
//var user_list = []; 스네이크 케이스, 띄어쓰기 부분을 _(언더바)로 구분한다.
//vat UserList = []; 카멜 케이스와 동일하지만 대문자로 시작한다. 주로 생성자에 사용된다.

/* 
var를 쓰면 안되는 이유
1) 변수 호이스팅이 일어난다.
2) 중복 선언이 가능하다.
3) 함수 레벨 스코프만 지원하고 블록 스코프는 지원하지 않는다.
