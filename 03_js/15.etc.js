...
function sumTotal() {
  // argument : 전달된 모든 인자를 유사배열 형태로 담는다.
...
console.log(obj === copy02); // obj와 copy02는 다른 객체다
...
let { name, age, foo, weight } = obj; //객체 비구조화 할당 {}안에 객체의 키값을 넣으면 해당 속성값을 같은 이름의 변수로 할당한다.
console.log(name, age, foo, weight);
